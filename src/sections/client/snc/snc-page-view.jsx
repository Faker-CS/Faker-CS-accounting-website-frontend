...
export default function SncPageView({ data, loading }) {
  ...
  return (
    <DashboardContent>
      ...
      {loading ? (
        ...
        <FileManagerView files={data} setServiceStatus={setServiceStatus} serviceId={5} />
      )}
    </DashboardContent>
  );
} 