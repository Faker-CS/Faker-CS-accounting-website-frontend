...
export const paths = {
  ...
  dashboard: {
    ...
    users: {
      ...
      showAideComptable: (id) => `${ROOTS.DASHBOARD}/users/aide-comptable/${id}`,
      employee: {
        root: `${ROOTS.DASHBOARD}/users/employee`,
        new: `${ROOTS.DASHBOARD}/users/employee/new`,
        edit: (id) => `${ROOTS.DASHBOARD}/users/employee/${id}/edit`,
        show: (id) => `${ROOTS.DASHBOARD}/users/employee/${id}`,
        view: (id) => `${ROOTS.DASHBOARD}/users/employee/${id}/view`,
      },
    },
    banking: {
